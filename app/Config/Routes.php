...
// Anime,Movie,Special,Ona,Ova vb listelendiği kısımdır.
$routes->get('type/(:any)', 'Anime::type_series/$1/');  //anime listeleme başarılıdır.
/// Az List kısmıdır.
$routes->get('az-list/(:any)', 'Anime::azsearch/$1/');  //anime listeleme başarılıdır.
// Anime ve Movie Listeme Kısmıdır
$routes->get('genre/(:any)', 'Anime::ani_genre/$1/');  //anime listeleme başarılıdır.
///Episode recent-releases
$routes->get('latest-episode', 'Anime::latest_episode');   //son eklenen bölümler
$routes->get('recent-releases', 'Anime::recent_releases');   //son eklenen anime / yapmadım.
//Anime çağırma router
//$routes->get('anime/(:segment)', 'Anime::getByAniuid/$1');  //test page 
$routes->get('anime/(:any)', 'Anime::anime_details/$1/');   //anime demo details
///aramalar kısmıdır.
