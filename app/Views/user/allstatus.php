                    ...
                    <div class="ph-tabs">
                        <div class="bah-tabs">
                            <ul class="nav nav-tabs pre-tabs">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="/user/profile/status/watching"><i class="fas fa-heart mr-2"></i>Watch List</a></li>
                    ...
                    <div class="profile-box profile-list profile-list-fav">
                        ...
                        <div class="fav-tabs mb-4">
                            <ul class="nav nav-tabs pre-tabs pre-tabs-min">
                                <li class="nav-item"> <a class="nav-link" id="watching-btn" data-status="1" href="<?php echo base_url(); ?>user/profile/status/watching">Watching</a></li>
                                <li class="nav-item"> <a class="nav-link" id="onhold-btn" data-status="2" href="<?php echo base_url(); ?>user/profile/status/on-hold">On-Hold</a></li>
                                <li class="nav-item"> <a class="nav-link" id="plan-to-watch-btn" data-status="3" href="<?php echo base_url(); ?>user/profile/status/plan-to-watch">Plan-to-Watch</a></li>
                                <li class="nav-item"> <a class="nav-link" id="dropped-btn" data-status="4" href="<?php echo base_url(); ?>user/profile/status/dropped">Dropped</a></li>
                                <li class="nav-item"> <a class="nav-link" id="completed-btn" data-status="5" href="<?php echo base_url(); ?>user/profile/status/completed">Completed</a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
