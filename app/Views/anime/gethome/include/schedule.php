    ...
    <div class="block_area-content">
                ...
                <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper schedule" id="scheduleDiv">
                        ...
                        for ($i = 1; $i <= $days_in_month; ++$i) {
                            ...
                            echo "<div class='swiper-slide day-item $activeClass' id='day-item-$i' onclick='rundaysCommand($i)' style='width: 140.714px; margin-right: 13px;'>
        ...
        <script>
            function rundaysCommand(days) {
                ...
                fetch(`/ajax/getdaysschedule/${days}`)
                    .then(response => response.json())
                    .then(data => document.getElementById("getdaysschedule").innerHTML = data.html)
                    .catch(error => console.error('Error:', error));
            }

            document.addEventListener("DOMContentLoaded", () => rundaysCommand(new Date().getDate()));
        </script>
    </div>
</section>