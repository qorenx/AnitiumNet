<div class="seasons-block seasons-block-max">
    <div id="detail-ss-list" class="detail-seasons">
        <div class="detail-infor-content">
            ...
            $page = 0;
            $page_size = 100;
            $count_episodes = count($EpisodeList);
            ...
            ?>
                <a id="getembed" class="ssl-item ep-item" title="<?= $EpisodeList[$i]->ep_name ?>" data-jname="<?= $EpisodeList[$i]->ep_jname ?>" onclick="handleClick(event,<?= $EpisodeList[$i]->uid ?>,<?= $EpisodeList[$i]->ep_id_name ?>)" href="/watch?anime=<?php
