                                    ...
                                    <?php foreach (array_slice($animedata, 0, 4) as $anime) : ?>
                                        <div class="flw-item flw-item-big">
                                            <div class="film-poster">
                                                <div class="tick ltr">
                                                    <div class="tick-item"><?= $anime['ani_ep']; ?></div>
                                                </div>
                                                ...
                                                <a class="film-poster-ahref item-qtip loaded" href="/anime/<?= $anime['uid'] ?>/<?= str_replace(' ', '-', $anime['ani_name']) ?>"><i class="fas fa-play"></i></a>
                                            </div>
