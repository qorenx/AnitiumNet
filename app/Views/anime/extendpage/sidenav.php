                ...
                <div class="cbox-content">
                    <div class="tab-content">
                        <div id="today-anime" class="anif-block-ul anif-block-chart tab-pane active">
                            <ul class="ulclear">
                            <?php $key = 1; foreach ($topanime as $topani): ?>
                                <li class="item-top">
                                <div class="film-number"><span><?= $key ?></span></div>
                                    ...
                                    <div class="film-detail">
                                        <h3 class="film-name">
                                            <a href="anime/<?= $topani['uid'] ?>/<?= preg_replace("/[\s\/]+/", "-", $topani['ani_name']) ?>" class="dynamic-name"><?= $topani['ani_name'] ?></a>
                                        </h3>
                                        <div class="fd-infor">
                                            <div class="tick">
                        ...
                        <div id="month-anime" class="anif-block-ul anif-block-chart tab-pane">
                            <ul class="ulclear">
                            <?php $key = 1; foreach ($topmonthanime as $topani): ?>
                                <li class="item-top">
                                <div class="film-number"><span><?= $key ?></span></div>
                                    <div class="film-poster item-qtip loaded">
                                        <img class="film-poster-img ls-is-cached lazyloaded"  src="<?= $topani['ani_poster'] ?>">
                        ...
                        <div id="years-anime" class="anif-block-ul anif-block-chart tab-pane">
                            <ul class="ulclear">
                            <?php $key = 1; foreach ($topyearsanime as $topani): ?>
                                <li class="item-top">
                                <div class="film-number"><span><?= $key ?></span></div>
                                    <div class="film-poster item-qtip loaded">
                                        <img class="film-poster-img ls-is-cached lazyloaded"  src="<?= $topani['ani_poster'] ?>">
