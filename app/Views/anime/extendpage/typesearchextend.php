<section class="block_area block_area_category">
    <div class="block_area-header">
        <div class="float-left bah-heading mr-4">
            <h2 class="cat-heading"><?= strtoupper($typesearch) ?></h2>
        </div>
                ...
                <?php foreach (array_slice($animetv, 0, 4) as $anime) : ?>
                    <div class="flw-item flw-item-big">
                        <div class="film-poster">
                            ...
                            <?php endif; ?>
                            <img class="film-poster-img lazyload" src="<?= $anime['ani_poster'] ?>" alt="">
                            <a class="film-poster-ahref item-qtip loaded" aria-describedby="qtip-0" href="/anime/<?= $anime['uid'] ?>/<?= str_replace(' ', '_', $anime['ani_name']) ?>" title="<?= $anime['ani_name'] ?>"><i class="fas fa-play"></i></a>
                        </div>
