        ...
        <div class="info">
            ...
            <div class="ibottom">
                ...
                <div class="ib-li ib-like">
                    <a style="color:white;" id="postrepylikelink-<?= $post['post_id'] ?>" onclick="addRepyLike(<?= $post['post_id'] ?>)" class="btn cm-btn-vote">
                        <i class="far fa-thumbs-up mr-1"></i><span id="boardrepylikepost-<?= $post['post_id'] ?>" class="value"><?= $post['post_rep'] ?>
                        </span>
                    </a>
                </div>
                <div class="ib-li ib-dislike">
                    <a style="color:white;" id="postrepydislink-<?= $post['post_id'] ?>" onclick="addRepyDislike(<?= $post['post_id'] ?>)" class="btn cm-btn-vote">
                        <i class="far fa-thumbs-down mr-1"></i><span id="boardrepydislikepost-<?= $post['post_id'] ?>" class="value"><?= $post['post_disrep'] ?>
                        </span>
                    </a>
                </div>
                <div class="ib-li">
