                        ...
                        <div class="nc-wrap">
                            ...
                            <div class="nc-body">
                                ...
                                <div class="nc-list">
                                    ...
                                    <button style="margin: 0 auto; display: none; font-size: 16px; padding: 10px 20px; background-color: #353b4d; color: #fff; border: none; border-radius: 5px; cursor: pointer;" onclick="getboardlastpost()" id="viewpostbutton">Show Post</button>
                                    <script>
                                        var nextPage = 1;
                                        var xhr = new XMLHttpRequest();

                                        function getboardlastpost() {

                                            var url = "/ajax/getboardlastpost?page=" + nextPage;
                                        ...
                                        document.addEventListener("DOMContentLoaded", getboardlastpost);
                                    </script>
                                </div>
                            </div>
                        </div>
