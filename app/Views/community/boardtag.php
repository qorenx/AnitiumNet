...
<body data-page="page_profile" style="max-width:100%!important;width:100%!important;">
    <div id="wrapper" data-page="page_home">
        ...
        <?= $this->include('community/extend/head') ?>
        <div class="clearfix"></div>
                            ...
                            <div class="nc-body">
                                ...
                                <div class="nc-list">
                                    ...
                                    <script>
                                        ...
                                        function getboardtagpost() {
                                            var type = "<?php echo $_GET['type']; ?>";
                                            var url = "/ajax/getboardtagpost?type=" + type + "&page=" + nextPage;
                                        ...
                                        document.addEventListener("DOMContentLoaded", getboardtagpost);
                                    </script>
                                </div>
                            </div>
                        </div>
