                                            ...
                                            <?php foreach (array_slice($animelist, 0, 10) as $key => $value) : ?>
                                                <div class="flw-item">
                                                    <div class="film-poster">
                                                        ...
                                                        <a class="film-poster-ahref" data-id="<?php echo $value['uid'] ?>" href="<?php echo base_url('anime/' . $value['uid'] . '/'); ?>
<?php
...
?>"><i class="fas fa-play"></i></a>
                                                    ...
                                                    <div class="film-detail">
                                                        <h3 class="film-name"><a href="<?php echo base_url('anime/' . $value['uid'] . '/'); ?>
<?php
                                                $nameParts = explode(',', $value['ani_name'], 2);
                                                if (count($nameParts) > 1) {
                                                    $name = trim($nameParts[1]);
