...
<?php else : ?>
    ...
    <div id="header_right">
        <div id="user-slot">
            <div class="header_right-user logged">
                <div class="dropdown">
                    <a class="btn-user btn btn-sm btn-primary btn-login" data-toggle="modal" data-target="#modallogin" data-tab-show="#modal-tab-login"><i class="fa-solid fa-user-astronaut fa-beat"></i> Login</a>
                </div>
            </div>
        </div>
    </div>
