      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
            <div class="card-header">Community Main Report</div>
              ...
              <tbody>
                ...
                foreach ($boardreport as $report) : ?>
                  <tr>
                    ...
                    <td>
                      <form method="post" action="/admin/report/board/main/reportdeleted">
                    ...
                    <td>
                      <form method="post" action="/admin/report/board/main/commentandreportdeleted">
