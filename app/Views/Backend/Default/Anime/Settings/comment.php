                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        ...
                        <form action="<?php echo base_url('admin/settings/update'); ?>" method="post">
                            <input type="hidden" name="id" id="id" value="<?php echo $settings['Comment'][0]['id']; ?>" class="form-control" readonly>
                            <div class="form-group row border-bottom">
                                <label for="value" class="col-sm-4 col-form-label"><?php echo $settings['Comment'][0]['class']; ?>:</label>
                                <div class="col-sm-7">
                                    <input type="text" name="value" id="value" value="<?php echo $settings['Comment'][0]['value']; ?>" class="form-control">
                                </div>
                                <div class="col-sl-1">
