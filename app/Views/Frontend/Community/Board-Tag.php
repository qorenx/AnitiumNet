            ...
            <div class="container">
                <div class="award-inner">
                    ...
                    <div class="new-connect">
                        <div class="nc-wrap">
                            <?= $this->include('Frontend/Community/NC-SideBar') ?>
                            <div class="nc-body">
                                <div class="nc-head">
                                    <div class="is-right">
                                ...
                                <div class="nc-list">
                                    ...
                                    <button style="margin: 0 auto; display: none; font-size: 16px; padding: 10px 20px; background-color: #353b4d; color: #fff; border: none; border-radius: 5px; cursor: pointer;" onclick="getboardtagpost()" id="viewpostbutton">Show Post</button>
                                    <script>
                                        var nextPage = 1;
                                        var xhr = new XMLHttpRequest();

                                        function Get_BoardTagPost() {
                                            var type = "<?php echo $_GET['type']; ?>";
                                            var url = "/ajax/get-boardtagpost?type=" + type + "&page=" + nextPage;
                                        ...
                                        document.addEventListener("DOMContentLoaded", Get_BoardTagPost);
                                    </script>
                                </div>
                            </div>
                        </div>
