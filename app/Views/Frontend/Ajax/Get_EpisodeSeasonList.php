<div class="seasons-block seasons-block-max">
    <div id="detail-ss-list" class="detail-seasons">
        <div class="detail-infor-content">
            ...
            ?>
                <a id="getembed" class="ssl-item ep-item-<?= $EpisodeListData[$i]->ep_id_name ?>" title="<?= $EpisodeListData[$i]->ep_name ?>" data-jname="<?= $EpisodeListData[$i]->ep_jname ?>" onclick="getEmbedServer(event,<?= $EpisodeListData[$i]->uid ?>,<?= $EpisodeListData[$i]->ep_id_name ?>)" href="/watch?anime=<?php
