        ...
        <div class="detail-infor-content">
            ...
            <div id="episodes-load" class="ss-list" style="display:block;">
                <?php foreach ($EpisodeListData as $episode) : ?>
                    <a class="ssl-item ep-item-<?= $episode->ep_id_name ?>" title="<?= $episode->ep_name ?>" data-jname="<?= $episode->ep_jname ?>" data-number="<?= $episode->ep_id_name ?>" data-id="<?= $episode->uid ?>" onclick="getEmbedServer(event,<?= $episode->uid ?>,<?= $episode->ep_id_name ?>)" href="/watch?anime=<?php
