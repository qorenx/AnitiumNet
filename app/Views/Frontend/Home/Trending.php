        ...
        <div class="trending-list" id="trending-home">
            <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                <div class="swiper-wrapper">
                    <?php $key = 1;
                    foreach ($TrendingData as $AnimeData) : ?>
                        <div class="swiper-slide">
                            <div class="item">
                                <div class="number">
                                    <span><?= $key ?></span>
                                    <div class="film-title dynamic-name"><?= $AnimeData['ani_name'] ?>
                                    </div>
                                </div>
                                <a href="/anime/<?= $AnimeData['uid'] ?>/<?php
                                                                            ...
                                                                            echo $slug;
                                                                            ?>" class="film-poster">
                                    <img class="film-poster-ahref" data-id="<?php echo $AnimeData['uid'] ?>" src="<?= $AnimeData['ani_poster'] ?>" class="film-poster-img lazyload">
                                </a>
                                <div class="clearfix"></div>
                            </div>
                        </div>
