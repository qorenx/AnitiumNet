                                            ...
                                            <?php foreach (array_slice($animelist, 0, 10) as $key => $value) : ?>
                                                <div class="flw-item">
                                                    <div class="film-poster">
                                                        ...
                                                        <a class="film-poster-ahref" data-id="<?php echo $value['uid'] ?>" href="<?php echo base_url('anime/' . $value['uid'] . '/'); ?><?php
                                                    ...
                                                    <div class="film-detail">
                                                        <h3 class="film-name"><a href="<?php echo base_url('anime/' . $value['uid'] . '/'); ?><?php
                                                                                                                                                $slug = trim(preg_replace("/[^\w\s\-]+/", "", $value['ani_name']), " ");
                                                                                                                                                $slug = preg_replace("/\s+|--/", "_", $slug);
                                                                                                                                                $slug = preg_replace("/\bii\b/", "II", $slug);
                                                                                                                                                $slug = preg_replace('/_-_|_{2,}/', '_', $slug);
