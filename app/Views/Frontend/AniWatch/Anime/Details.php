                ...
                <div class="anisc-poster">
                    ...
                    <?php if (!empty($AnimeData['ani_pv'])) : ?>
                        <div class="d-flex align-items-center">
                            <?= $this->include('Frontend/AniWatch/Anime/PromeVideo') ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="anisc-detail">
                    ...
                    <div class="film-buttons">
                        ...
                        <?php if (auth()->loggedIn()) : ?>
                            <?= $this->include('Frontend/AniWatch/Anime/WatchStatus') ?>
                        <?php endif; ?>
                        <?php if (isset(auth()->user()->groups[0]) && in_array(auth()->user()->groups[0], ['superadmin', 'admin'])) : ?>
                            <?= $this->include('Frontend/AniWatch/Anime/AdminMenu') ?>
                        <?php endif; ?>
                    </div>
                    ...
                    <?= $this->include('Frontend/AniWatch/Anime/SocialButton') ?>
                    <div class="anisc-info-wrap">
                        <div class="anisc-info">
                            ...
                            <?php if (!empty($AnimeData['ani_studio'])) : ?>
                                <?= $this->include('Frontend/AniWatch/Anime/Studio') ?>
                            <?php endif; ?>
                            <?php if (!empty($AnimeData['ani_producers'])) : ?>
                                <?= $this->include('Frontend/AniWatch/Anime/Producers') ?>
                            <?php endif; ?>
                            <?php if (!empty($AnimeData['external'])) : ?>
                                <?= $this->include('Frontend/AniWatch/Anime/Resources') ?>
                            <?php endif; ?>
                        </div>
