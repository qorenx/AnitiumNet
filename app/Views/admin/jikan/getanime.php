            ...
            foreach ($data as $item) { ?>
                <div class="card-body" style="margin: 0% 10%;">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="#myanimelist" data-toggle="tab">Manuel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#posterwallpaper" data-toggle="tab">Anime Poster/Wallpaper</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade show active" id="myanimelist">
                            ...
                            <div class="form-group row">
                                <label for="ani_offical_site" class="col-sm-4 col-form-label">Resources:</label>
                                <div class="col-sm-8">
                                    <input type="text" name="ani_offical_site" id="ani_offical_site" value="<?php $external = array();
                                                                                                            ...
                                                                                                            echo htmlspecialchars($result, ENT_QUOTES); ?>" class="form-control">
                                </div>
                            </div><br>
                            <br>
                            <div class="form-group row">
