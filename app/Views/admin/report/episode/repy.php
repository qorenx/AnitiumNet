            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card-header">Episode Repy Report</div>
                            ...
                            <tbody>
                                ...
                                foreach ($commentreport as $report) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="/admin/report/episode/repy/reportdeleted">
                                        ...
                                        <td>
                                            <form method="post" action="/admin/report/episode/repy/commentandreportdeleted">
