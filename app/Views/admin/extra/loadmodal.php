    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?= base_url('/admin/episode/getoneepisode/'); ?>" method="get">
                <div class="modal-header">
                    <h5 class="modal-title" id="getepisode-modalLabel" style="color:black">Enter Anime ID</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group" style="background-color: #0709644a;">
                        <h5 class="modal-title" id="getepisode-modalLabel" style="color:black">MyAnimeList Anime ID</h5>
                        <input type="text" name="uid" class="form-control" required>
                        <h5 class="modal-title" id="getepisode-modalLabel" style="color:black">Episode ID</h5>
