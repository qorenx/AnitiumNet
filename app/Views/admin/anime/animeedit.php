        ...
        <form action="<?php echo base_url('admin/anime/anime-edit'); ?>" method="post">
            <div class="card-body" style="margin: 0 20%; border: 6px solid black; background-color: #120000; color: white; font-weight: bold;">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="uid" id="uid" value="<?php echo $animeedit['uid']; ?>" class="form-control" readonly>
                    </div>
                </div><br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="ani_country" class="col-sm-4 col-form-label">Anime Type: </label>
                    <div class="col-sm-8">
