...
<body>
    <div id="wrapper" data-page="page_home">
        <form action="<?php echo base_url('admin/episode/episode-dub-add'); ?>" method="post">
            <div class="card-body" style="margin: 0% 10%;">
                ...
                <div class="form-group row">
                    <label for="dub_id" class="col-sm-4 col-form-label">Episode ID(1, 1.5 etc):</label>
                    <div class="col-sm-8">
                        <input type="number"  name="dub_id" id="dub_id" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="ep_dub_webconverter" class="col-sm-4 col-form-label">Auto/Manuel Embed:</label>
                    <div class="col-sm-8">
                        <select name="ep_dub_webconverter" id="ep_dub_webconverter" class="form-control">
                            <option value="2">GogoAnime AutoEmbed</option>
                ...
                <template>
                    <div class="form-group row">
                        <label for="dub_name" class="col-sm-4 col-form-label">Short Name Provider:</label>
                        <div class="col-sm-8">
                            <input type="text" name="dub_name[]" id="dub_name" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="dub_frame" class="col-sm-4 col-form-label">Video URL:</label>
                        <div class="col-sm-8">
                            <input type="text" name="dub_frame[]" id="dub_frame" class="form-control" required>
                        </div>
                    </div>
                </template>
