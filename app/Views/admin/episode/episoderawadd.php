...
<body>
    <div id="wrapper" data-page="page_home">
        <form action="<?= base_url('admin/episode/episode-raw-add') ?>" method="post">
            <div class="card-body" style="margin: 0% 10%;">
                ...
                <template>
                    <div class="form-group row">
                        <label for="raw_name" class="col-sm-4 col-form-label">Short Name Provider:</label>
                        <div class="col-sm-8">
                            <input type="text" name="raw_name[]" id="raw_name" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="raw_frame" class="col-sm-4 col-form-label">Video URL:</label>
                        <div class="col-sm-8">
                            <input type="text" name="raw_frame[]" id="raw_frame" class="form-control" required>
                        </div>
                    </div>
                </template>
