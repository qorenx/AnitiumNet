...
class EpisodeRepyRep extends Model
{
    protected $table = 'episode_repy_rep';
    ...
    public function episoderepyrep($postid, $userid)
    {
        $table = $this->db->table('episode_repy_rep');
        $conditions = [
            'user_id' => $userid,
            'post_id' => $postid,
        ];
    ...
    public function episoderepydisrep($postid, $userid)
    {
        $table = $this->db->table('episode_repy_rep');
        $conditions = [
            'user_id' => $userid,
