...
class EpisodeMainRep extends Model
{
    protected $table = 'episode_main_rep';
    ...
    public function episodemainrep($postid, $userid)
    {
        $table = $this->db->table('episode_main_rep');
        $conditions = [
            'user_id' => $userid,
            'post_id' => $postid,
        ];
    ...
    public function episodemaindisrep($postid, $userid)
    {
        $table = $this->db->table('episode_main_rep');
        $conditions = [
            'user_id' => $userid,
    ...
    public function episoderepcount($postid)
    {
